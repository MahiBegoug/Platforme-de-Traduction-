...
<body class="">
  <div class="wrapper ">
    <div class="sidebar" data-color="orange" >
      ...
      <!--   <li>
         <a href="{{url('notificationTraducteur')}}">
         ...
         <li>
          <a href="{{url('propositionDevis')}}">
              <i class="now-ui-icons  ui-1_bell-53"></i>
              <p>Propositions de Devis</p>
          </a>
          </li>

          <li>
            <a href="{{url('coutTraduction')}}">
                <i class="now-ui-icons business_money-coins"></i>
                <p>Coût de Traduction</p>
            </a>
            </li>

          <li>
            <a href="{{url('profileTraducteur')}}">
